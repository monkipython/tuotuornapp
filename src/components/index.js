...
export const ReviewsItem = _ReviewsItem
...
import _AddToCartModal from './AddToCartModal'
export const AddToCartModal = _AddToCartModal

import _VariationItem from './VariationItem'
export const VariationItem = _VariationItem
